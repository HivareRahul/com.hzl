...
/*jQuery.sap.declare("com.hzl.Controller.FluTrnQulAnlyEntry.fluTrnsQulAnlyEntrPersoService");
...
com.hzl.Controller.FluTrnQulAnlyEntry.fluTrnsQulAnlyEntrPersoService = {
	oData : {
		...
		aColumns : [
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-date",
					order: 0,
					text: "{i18n>FTQAE_dt}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-shift",
					order: 1,
					text: "{i18n>FTQAE_shift}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-matTrans",
					order: 2,
					text: "{i18n>FTQAE_matTrns}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-matTransFrm",
					order: 3,
					text: "{i18n>FTQAE_MTF}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-matTransTo",
					order: 4,
					text: "{i18n>FTQAE_matTrnsTo}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-znGpl",
					order: 5,
					text: "{i18n>FTQAE_znGPL}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-znGplUOM",
					order: 6,
					text: "{i18n>FTQAE_znGplUOM}",
					visible: false
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-znDen",
					order: 7,
					text: "{i18n>FTQAE_znDen}",
					visible: true
				},
				{
					id: "FTQAE-fluTrnsQulAnlyEntTable-znDenUOM",
					order: 8,
					text: "{i18n>FTQAE_znDenUOM}",
					visible: false
				}
